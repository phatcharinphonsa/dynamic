...
public class Movies extends Model {
    ...
    public Movies(String id, String name, String address, String pduct, String number,
    ...
    ////////////////////////////////////////
    public static Model.Finder<String, Movies> find = new Model.Finder<String, Movies>(String.class, Movies.class);

    public static void create(Movies auto) {

        auto.save();
    }

    public static List<Movies> retrieve() {

        return find.all();
    }

    public static List<Movies> retrieveAddress(String address) {

        return find.where().eq("address", address).findList();
    }

    public static List<Movies> retrieveID(String id) {

        return find.where().eq("id", id).findList();
    }

    public static List<Movies> retrieveLand(String land) {

        return find.where().eq("land", land).findList();
    }

    public static void update(Movies auto) {

        auto.update();
    }

    public static void delete(Movies auto) {
